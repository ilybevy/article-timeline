...
# ---------------------------
# EMBEDDING FUNCTION (bạn thay bằng model thật)
# ---------------------------
def embed_fn(text: str):
    return np.random.rand(768)   # TODO: thay bằng embedding model thật
...
def make_details(
    ...
    # INIT THEME WRITER (chỉ tạo 1 lần)
